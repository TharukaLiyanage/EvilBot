...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/91172110df2a84e882c4b.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *NISHA BOT*
...
buttons = [
    [
     ...
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url="https://www.youtube.com/channel/UCQRO2A9AGhhpD7CL77iEqiQT"),
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👿 *NISHA BOT* [👿](https://telegra.ph/file/a064bd8497a5f6f03b290.mp4)
